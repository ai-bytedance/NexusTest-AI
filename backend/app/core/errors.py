...
class ErrorCode(str, Enum):
    ...
    AUTH_SSO_NOT_CONFIGURED = "AUTH004"
    AUTH_SSO_STATE_INVALID = "AUTH005"
    AUTH_SSO_LINK_CONFLICT = "AUTH006"
    REPORT_NOT_FOUND = "R001"
    REPORT_EXPORT_UNSUPPORTED = "R002"
    REPORT_EXPORT_TEMPLATE_UNKNOWN = "R003"
    REPORT_EXPORT_TOO_LARGE = "R004"
    REPORT_EXPORT_ENGINE_UNAVAILABLE = "R005"
    REPORT_EXPORT_FORMAT_UNSUPPORTED = "R006"
